...
public class MixerStrategy extends DrinkStrategy {
    ...
    private String[] mixers = {"Orange Juice", "Tonic Water", "Coke", "Sprite", "Mountain Dew", "Sour Mix", "Red Bull", "Pineapple Juice", "Cranberry Juice", "Tomato Juice", "Milk", "Lemonade", "Limeade", "Grapefruit Juice", "Grenadine Syrup"};
