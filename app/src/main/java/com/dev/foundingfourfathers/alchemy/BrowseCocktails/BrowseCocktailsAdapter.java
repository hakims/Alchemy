...
class BrowseCocktailsAdapter extends BaseAdapter {

    private final LayoutInflater dLayoutInflater;
    private final int dResourceId;

    public BrowseCocktailsAdapter(LayoutInflater inflater, int resourceId) {
    ...
    @Override
    public int getCount() {
        return MixedDrink.ALL_MIXED_DRINKS.length;
    }
